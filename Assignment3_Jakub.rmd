...
get_prior(AI_VoiceHearing_f0, family = gaussian,schizoData)
...
all_you_need <- function(your_formula, prior, your_relationship){
...
## voice hearing
VoiceHearing0 <- 
  all_you_need(AI_VoiceHearing_f0, prior0, your_relationship = "VoiceHearing > 0")

print_print(VoiceHearing0)

## mind reading
MindReading0 <- 
  all_you_need(AI_MindReading_f0, prior0, your_relationship = "MindReading > 0")

print_print(MindReading0)

## apathy
Apathy0 <- 
  all_you_need(AI_Apathy_f0, prior0, your_relationship = "Apathy > 0")
